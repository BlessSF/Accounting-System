<?php
// ============================================================
//  pub_express_tb.php — Pub Express Trial Balance
...
// ── Section definitions ──
// ASSETS / EXPENSES now come from pub_express_acc_titles (managed via
// pub_express_acc_title.php) instead of being hardcoded here. REVENUE stays
// fixed since those rows aren't part of the disbursement-driven masterlist.
...
if (isset($_GET['export_csv'])) {
    ...
    header('Content-Disposition: attachment; filename="Pub_Express_TB_'.$YEAR.'.csv"');
    $out = fopen('php://output','w');
    fputcsv($out, ['MERITONI CORP — Pub Express Trial Balance', $YEAR]);
    fputcsv($out, []);
...
<div class="section-header" style="display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:10px;margin-bottom:20px">
  <div>
    <div class="section-title">Pub Express <span>Trial Balance</span></div>
    <div class="section-subtitle">MERITONI CORP · Assets, Revenue &amp; Expenses by month · <?= $YEAR ?></div>
  </div>
  <div style="display:flex;gap:8px;align-items:center;flex-wrap:wrap">
    <a href="pub_express_disbursement.php" class="nav-btn btn-dsb">📒 Disbursement</a>
    <a href="pub_express_sum.php?year=<?= $YEAR ?>" class="nav-btn btn-sum">📋 Sum</a>
    <a href="pub_express_acc_title.php" class="nav-btn" style="background:#6D4C41;color:#fff;box-shadow:0 2px 8px rgba(109,76,65,.3)">🏷 Account Titles</a>
  </div>
</div>
