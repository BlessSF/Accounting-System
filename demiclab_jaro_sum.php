<?php
// ============================================================
//  demiclab_jaro_sum.php — DemicLab-Jaro Sum / Checking View
...
if (isset($_GET['export_csv'])) {
    ...
    // Account title rows now come from demiclab_jaro_acc_titles (managed via
    ...
    header('Content-Disposition: attachment; filename="demiclab_jaro_sum_'.$YEAR.'.csv"');
    $out = fopen('php://output','w');
    fputcsv($out, ['DemicLab-Jaro — Sum / Checking', $YEAR]);
    fputcsv($out, []);
...
$pageTitle  = 'DemicLab-Jaro Sum';
$activePage = 'demiclab_jaro_disbursement'; // keep Disbursement active in sidebar
include 'layout.php';
?>
...
<div class="section-header">
  <div>
    <div class="section-title">DemicLab-Jaro <span>Sum</span></div>
...
<div class="sum-controls">
  ...
  <a href="?year=<?= $YEAR+1 ?>" class="yr-btn"><?= $YEAR+1 ?> →</a>
  <a href="demiclab_jaro_disbursement.php" class="btn-action">📒 Go to Disbursement</a>
  <a href="demiclab_jaro_acc_title.php" class="btn-action" style="border-color:#6D4C41;background:#EFEBE9;color:#4E342E">🏷 Account Titles</a>
